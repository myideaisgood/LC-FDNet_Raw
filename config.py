...
def parse_training_args(parser):
    ...
    parser.add_argument('--weights', type=str, default="ckpt.pth", help='Fill In Fill In')
    parser.add_argument('--encode_dir', type=str, default="encode_results/", help='Directory of where encoded results are stored')
    parser.add_argument('--decode_dir', type=str, default="decode_results/", help='Directory of where decoded images are stored')
